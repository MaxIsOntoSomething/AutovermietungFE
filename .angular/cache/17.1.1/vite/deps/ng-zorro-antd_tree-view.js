...
function NzTreeVirtualScrollViewComponent_ng_container_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = ɵɵnextContext();
    ɵɵadvance();
    ɵɵproperty("data", item_r1)("compareBy", ctx_r0.compareBy);
  }
}
...
_NzTreeNodeToggleDirective.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    recursive: [InputFlags.None, "nzTreeNodeToggleRecursive", "recursive"]
  },
  standalone: true,
  features: [ɵɵProvidersFeature([{
...
_NzTreeNodePaddingDirective.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    level: [InputFlags.None, "nzTreeNodePadding", "level"],
